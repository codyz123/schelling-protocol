...
curl https://www.schellingprotocol.com/schelling/describe \
  -H 'Content-Type: application/json' \
  -d '{"version": "3.0"}'

# Find matches with natural language
curl https://www.schellingprotocol.com/schelling/quick_seek \
  -H 'Content-Type: application/json' \
  -d '{"version": "3.0", "intent": "React developer in Denver"}'
```

**Resources:**
- [Interactive API Playground](https://www.schellingprotocol.com/demo) — try operations in the browser
- [Swagger UI](https://www.schellingprotocol.com/docs) — full API reference
- [OpenAPI Spec](https://www.schellingprotocol.com/openapi.yaml) — import into any tool
...
client = SchellingClient("https://www.schellingprotocol.com")
...
```json
{
  "mcpServers": {
    "schelling": {
      ...
      "env": {
        "SCHELLING_URL": "https://www.schellingprotocol.com"
      }
    }
  }
}
...
- Import `https://www.schellingprotocol.com/openapi.yaml` as actions
...
- `https://www.schellingprotocol.com/.well-known/agent.json`

### AI Discovery (llms.txt)

For AI-native discovery:
- `https://www.schellingprotocol.com/llms.txt`

---

## Discovery Endpoints

All live at `https://www.schellingprotocol.com`:
