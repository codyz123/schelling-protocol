...
Real-world patterns for integrating Schelling Protocol into your agent stack. Each scenario is copy-paste ready against the live API at `https://schellingprotocol.com`.
...
BASE = "https://schellingprotocol.com/schelling"
...
```json
{
  "mcpServers": {
    "schelling": {
      ...
      "env": {
        "SCHELLING_API_URL": "https://schellingprotocol.com"
      }
    }
  }
}
...
```javascript
const BASE = 'https://schellingprotocol.com/schelling';
...
resp, _ := http.Post("https://schellingprotocol.com/schelling/quick_seek",
...
```ruby
uri = URI('https://schellingprotocol.com/schelling/quick_seek')
