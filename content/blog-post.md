...
def schelling_seek(intent: str) -> str:
    ...
    resp = httpx.post(
        "https://www.schellingprotocol.com/schelling/quick_seek",
        json={"intent": intent}
    )
...
- **Live API:** [schellingprotocol.com](https://www.schellingprotocol.com)
- **Interactive docs:** [schellingprotocol.com/docs](https://www.schellingprotocol.com/docs)
