...
cover_image: https://www.schellingprotocol.com/og-image.svg
...
This isn't hypothetical. It's running right now at [www.schellingprotocol.com](https://www.schellingprotocol.com).
...
curl -s https://www.schellingprotocol.com/status | jq .network
```
...
| Live API | [www.schellingprotocol.com](https://www.schellingprotocol.com) |
| Interactive Docs | [/docs](https://www.schellingprotocol.com/docs) |
| Live Demo | [/demo](https://www.schellingprotocol.com/demo) |
...
If you're building an AI agent that needs to find, evaluate, or negotiate with counterparts on behalf of its user — [try the API](https://www.schellingprotocol.com/demo), [open an issue](https://github.com/codyz123/schelling-protocol/issues), or [join the discussion](https://github.com/codyz123/schelling-protocol/discussions).
