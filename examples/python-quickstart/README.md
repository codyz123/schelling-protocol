...
Registers an apartment listing and a seeker on the [Schelling Protocol](https://www.schellingprotocol.com) live API, then displays match results.
...
All operations: `POST https://www.schellingprotocol.com/schelling/{operation}`
