...
const NESTED_OPERATIONS: Record<string, HandlerFn> = {
  ...
  // v4 public index
  "index/get": handleIndexGet,
  // v4 messaging
  "message/send": handleMessageSend,
  "message/inbox": handleMessageInbox,
  "message/respond": handleMessageRespond,
      ...
      fetch: async (req: Request) => {
        ...
        if (method === "GET" && url.pathname === "/.well-known/ai-plugin.json") {
          return Response.json({
            ...
            auth: { type: "none" },
            api: { type: "openapi", url: "https://schellingprotocol.com/openapi.yaml" },
          ...
          try {
            ...
            return Response.json({
              ...
              endpoints: {
                ...
                docs: "https://schellingprotocol.com/docs",
                demo: "https://schellingprotocol.com/demo",
              ...
              links: {
                ...
                spec: "https://schellingprotocol.com/openapi.yaml",
              }
            }, { headers: corsHeaders });
          } catch (e) {
          ...
          return Response.json(
            {
              ...
              hint: "Try: curl -X POST https://schellingprotocol.com/schelling/describe -H 'Content-Type: application/json' -d '{}'",
            },
