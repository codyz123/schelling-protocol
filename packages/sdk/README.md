...
const client = new Schelling('https://localhost:3000');
...
```typescript
// Custom server URL
const client = new Schelling('https://schelling.network');

// With existing token
const client = new Schelling('https://schelling.network', 'tok_...');
