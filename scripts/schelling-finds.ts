...
`;
  ...
  md += `\n---\n\n*Generated by [Schelling Finds](https://github.com/codyz123/a2a-assistant-matchmaker) — automated content using the live Schelling Protocol API at schellingprotocol.com.*\n`;
